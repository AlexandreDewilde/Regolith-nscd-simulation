...
plt.xlabel("Number of particles", fontsize=14)
plt.plot(particles_count, [cats_df[("False", "False", i)]["solve"] for i in particles_count], label="Brute force")
plt.plot(particles_count, [cats_df[("True", "False", i)]["solve"] for i in particles_count], label="KDTree")
